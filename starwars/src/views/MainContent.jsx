          ...
          return (
            <>
              <Segment>
                ...
                <Button primary
                        as="a"
                        href={`https://www.starwars.com/databank/${kebabCase( character.name )}`}>More
                  Information</Button>
                </ListingContainer>
              </Segment>
              <Segment.Group>
                    ...
                    <Segment key={i}>
                      <ListingContainer>
                        ...
                        {filmId && <Button color="yellow"
                                           as="a"
                                           href={`https://www.starwars.com/films/star-wars-episode-${romanNum( filmId.episode_id )}-${kebabCase( filmId.title )}`}>Click
                          Here</Button>}
                      </ListingContainer>
                    </Segment>
                  );
